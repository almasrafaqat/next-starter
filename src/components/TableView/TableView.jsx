...
export function TableView({
  ...
  console.log("showBulkActions:", showBulkActions);
                            ...
                            <>
                              ...
                              <Menu
                                ...
                                open={
                                  ...
                                  selectedRowForAction?.id === row.id
                                }
                              ...
                              >
                                {customRowActions
                                  ...
                                  .map((action, index) => (
                                    <MenuItem
                                      key={index}
                                      onClick={() => {
                                        action.onClick(selectedRowForAction);
                                        handleActionMenuClose();
                                      }}
                                    >
                                ...
                                {actions.onDelete && (
                                  <>
                                    ...
                                    <MenuItem
                                      onClick={() => {
                                        actions.onDelete(selectedRowForAction);
                                        handleActionMenuClose();
                                      }}
                                      sx={{ color: "error.main" }}
                                    >
